...
public class Camera2BasicFragment extends Fragment
    ...
    //todo: my own variable to count up to 10 frames
    private int numberOfStoredFrames = 0;
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                //todo: my code, changing the size of the image captured to smallest possible
